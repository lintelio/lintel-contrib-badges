 ...
 * https://github.com/lintelio/lintel-contrib-badges
 *
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    sass: {
      ...
      dist: {
        files: {
          '<%= lintel.dist %>/badges.css': 'sass/lintel-core-loader.scss'
        }
      }
    },
    ...
    cssmin: {
      ...
      dist: {
        src: '<%= lintel.dist %>/badges.css',
        dest: '<%= lintel.dist %>/badges.min.css'
      }
    },
    ...
    webshot: {
      xs: {
        options: {
          siteType: 'url',
          site: 'http://localhost:4554/badges.html',
